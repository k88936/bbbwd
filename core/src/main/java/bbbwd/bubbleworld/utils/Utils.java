...
//    public class Angle{
//        public float angleDeg (Vector2 reference) {var that=new Vector2(1,2);
//            float angle = (float)Math.atan2(reference.x * that.y - reference.y * that.x, reference.x * that.x + reference.y * that.y) * MathUtils.radiansToDegrees;
