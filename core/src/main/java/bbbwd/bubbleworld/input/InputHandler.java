...
//                Gdx.app.log("check entity: " + entityId);
                ...
                inv.applyTo(local);
                TypeCM typeCM = Vars.ecs.getMapper(TypeCM.class).get(entityId);
                ...
                Block oldBlockType = typeCM.blockType;
...
//            connection.relativeAngle = 0;
    ...
    public int buildBlock(Affine2 transform, Block newBlock) {
        return newBlock.create(transform);
    }

    public void buildAndConnect(SeekResult seekResult) {
